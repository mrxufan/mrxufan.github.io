                 ...
                 layer.open({
                     ...
                     content: `
                        <div style='margin:20px;'>
                            <textarea placeholder='请输入驳回原因' style='width:100%;padding:10px;' name="" rows="8"></textarea>
                        </div>
                    `,
                     yes: function(index, layero) {
 ...
 var ButtonInit = function() {
     ...
     oInit.Init = function() {
         ...
         $("#btn_check").on('click', function() {
             ...
             if (a.length == 0) {
                 layer.msg('请选择要审核的审核单');
             } else {
                 //获取选中的ID
                 for (var i = 0; i < a.length; i++) {
                     delData[i] = a[i].orgId;
                 }
                 console.log('审核的数据', delData);
                 ...
                 layer.open({
                     ...
                     btnAlign: 'c',
                     content: '<div style="margin:20px">确定一键通过选中的审核单?</div>'
                 });
