                     ...
                     <div class="modal-body table-layer" style="padding: 0;margin: 0 20px;z-index: 10">
                            <div class="form-group col-md-12" style="padding: 0;margin: 0;padding-top: 8px;z-index: 10">
                                <div class="col-md-3" style="padding: 0;margin: 0;text-align: right;">
                                    <label for="orgCode"><i class="must-star">*</i>供应商名称：</label>
                                </div>
                            ...
                            <div class="form-group col-md-12" style="padding: 0;margin: 0;padding-top: 8px;z-index: 10">
                                <div class="col-md-3" style="padding: 0;margin: 0;text-align: right;">
                                    <label for="orgCode"><i class="must-star">*</i>联系人：</label>
                                </div>
                                <div class="col-md-9" style="padding: 0;margin: 0">
                                    <input autocomplete="off" name="orgName" type="text" class="form-control" />
                                </div>
                            ...
                            <div class="form-group col-md-12" style="padding: 0;margin: 0;padding-top: 8px;z-index: 10">
                                <div class="col-md-3" style="padding: 0;margin: 0;text-align: right;">
                                    <label for="orgCode"><i class="must-star">*</i>联系电话：</label>
                                </div>
                                <div class="col-md-9" style="padding: 0;margin: 0">
                                    <input autocomplete="off" name="orgName" type="text" class="form-control" />
                                </div>
                            ...
                            <div class="form-group col-md-12" style="padding: 0;margin: 0;padding-top: 8px;z-index: 10">
                                <div class="col-md-3" style="padding: 0;margin: 0;text-align: right;">
                                    <label for="orgCode"><i class="must-star">*</i>地址：</label>
                                </div>
                                <div class="col-md-9" style="padding: 0;margin: 0">
                                    <input autocomplete="off" name="orgName" type="text" class="form-control" />
                                </div>
                            ...
                            <div class="form-group col-md-12" style="padding: 0;margin: 0;padding-top: 8px;z-index: 10">
                                <div class="col-md-3" style="padding: 0;margin: 0;text-align: right;">
                                    <label for="orgCode"><i class="must-star">*</i>邮件：</label>
                                </div>
                                <div class="col-md-9" style="padding: 0;margin: 0">
                                    <input autocomplete="off" name="orgName" type="text" class="form-control" />
                                </div>
                            ...
                            <div class="form-group col-md-12" style="padding: 0;margin: 0;padding-top: 8px;z-index: 10">
                                <div class="col-md-3" style="padding: 0;margin: 0;text-align: right;">
                                    <label for="orgCode"><i class="must-star">*</i>银行账号：</label>
                                </div>
                                <div class="col-md-9" style="padding: 0;margin: 0">
                                    <input autocomplete="off" name="orgName" type="text" class="form-control" />
                                </div>
