             ...
             columns: [{
                 ...
                 },
                 {
                     ...
                     formatter: function(value, row, index) {
                         var result = "<a href='javascript:;' class='info' style='margin-right:10px;'>详情</a><a href='javascript:;' class='print' style='border: 1px solid #3c8dbc;padding: 2px 6px;border-radius: 2px;'>打印</a>";
                         return result;
                     }
                 }
             ],
