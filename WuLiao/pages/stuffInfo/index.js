                     ...
                     <div class="modal-body table-layer" style="padding: 0;margin: 0 20px;z-index: 10">
                            <div class="form-group col-md-6" style="padding: 0;margin: 0;padding-top: 8px;">
                                <div class="col-md-4" style="padding: 0;margin: 0;text-align: right;">
                                    <label><i class="must-star">*</i>上级类型：</label></div>
                            ...
                            <div class="form-group col-md-6" style="padding: 0;margin: 0;padding-top: 8px;z-index: 10">
                                ...
                                <div class="col-md-8" style="padding: 0;margin: 0">
                                    <input readonly autocomplete="off" name="orgNumber" type="text" class="form-control" />
                                </div>
                            </div>
                            <div class="form-group col-md-6" style="padding: 0;margin: 0;padding-top: 8px;z-index: 10">
                                <div class="col-md-4" style="padding: 0;margin: 0;text-align: right;">
                            ...
                            <div class="form-group col-md-6" style="padding: 0;margin: 0;padding-top: 8px;z-index: 10">
                                <div class="col-md-4" style="padding: 0;margin: 0;text-align: right;">
                                    <label><i class="must-star">*</i>拼音码：</label>
                                </div>
                                <div class="col-md-8" style="padding: 0;margin: 0">
                                    <input autocomplete="off" name="orgName" type="text" class="form-control" />
                                </div>
                            ...
                            <div class="form-group col-md-6" style="padding: 0;margin: 0;padding-top: 8px;z-index: 10">
                                <div class="col-md-4" style="padding: 0;margin: 0;text-align: right;">
                                    <label><i class="must-star">*</i>单位：</label>
                                </div>
                                <div class="col-md-8" style="padding: 0;margin: 0">
                                    <select class="form-control">
                                        <option>1</option>
                            ...
                            <div class="form-group col-md-6" style="padding: 0;margin: 0;padding-top: 8px;z-index: 10">
                                <div class="col-md-4" style="padding: 0;margin: 0;text-align: right;">
                                    <label><i class="must-star">*</i>规格：</label>
                                </div>
                                <div class="col-md-8" style="padding: 0;margin: 0">
                            ...
                            <div class="form-group col-md-6" style="padding: 0;margin: 0;padding-top: 8px;z-index: 10">
                                ...
                                <div class="col-md-8" style="padding:0;padding-right:30px;margin: 0;position:relative;">
                                    <div class="form-control"></div>
                                    <span style="position:absolute;right:0;top:8px;font-size:12px;cursor: pointer;color: #27AAE1;">生成</span>
                                </div>
                            </div>
